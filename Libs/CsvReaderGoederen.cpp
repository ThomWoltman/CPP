...
vector<Goederen_hoeveelheid> CsvReaderGoederen::get_goederen_hoeveelheid() {



        vector<Goederen_hoeveelheid> goederen;

        ifstream ip("/home/administrator/Documents/Workspace/CPP/data/goederen_hoeveelheid.csv");
